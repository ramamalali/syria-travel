...
<span className="font-headline-sm text-headline-sm font-bold text-primary">Syria Travel</span>
...
<a className="text-on-surface-variant hover:text-primary pb-1 font-body-md text-body-md cursor-pointer transition-colors" href="#destinations">من نحن</a>
<a className="text-on-surface-variant hover:text-primary pb-1 font-body-md text-body-md cursor-pointer transition-colors" href="#destinations">كنوزنا الأثرية</a>
<a className="text-on-surface-variant hover:text-primary pb-1 font-body-md text-body-md cursor-pointer transition-colors" href="#turistdestinations">الرحلات</a>
