...
function Hero() {
  ...
  const confirmBooking = () => {
    alert("تم تسجيل طلبك بنجاح!\nيرجى مراجعة المكتب لتثبيت الحجز ودفع الرسوم في أقرب وقت.");
    handleCloseModal();
  };

  // دالة لتغيير نقطة بداية حجز المقاعد المتتالية من القائمة المنسدلة
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <div className="relative bg-surface-container-lowest w-full max-w-xl max-h-[90vh] overflow-hidden rounded-xl shadow-2xl flex flex-col scale-100 opacity-100 animate-scaleUp">
            ...
            >
              {/* الخطوة 1: تفاصيل الوجهة والسياح */}
              {currentStep === 1 && (
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center gap-2 border border-outline-variant/50 rounded-xl p-3 bg-white focus-within:border-primary transition-all">
                        ...
                        <input className="w-full border-none focus:ring-0 text-sm p-0 outline-none" placeholder="قلعة الحصن، تدمر، أفاميا..." type="text" />
                      </div>
                    </div>
                  </div>
              ...
              {/* الخطوة 2: اختيار البرنامج والمقاعد الديناميكية */}
              {currentStep === 2 && (
                <div className="space-y-5 animate-fadeIn">
                  ...
                  {/* حجز المقاعد المطور بناءً على عدد الأشخاص */}
              ...
              {/* الخطوة 3: ملخص الحجز والخيارات المقيدة */}
              {currentStep === 3 && (
                <div className="space-y-5 animate-fadeIn">
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      ...
                      {/* في المكتب - هي المفعلة والنشطة دائماً */}
